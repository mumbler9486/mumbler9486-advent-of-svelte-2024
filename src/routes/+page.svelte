			...
			<div class="py-6">
				...
				<p class="mt-4">
					<a
						...
						href="https://github.com/mumbler9486/mumbler9486-advent-of-svelte-2024"
						target="_blank"
				...
				<div class="grid grid-cols-4 items-center gap-4">
					...
					<a class="btn btn-primary" href="/day12">Day 12</a>
					<a class="btn btn-primary" href="/day13">Day 13</a>
					<a class="btn btn-primary" href="/day14">Day 14</a>
					<a class="btn btn-primary" href="/day15">Day 15</a>
					<a class="btn btn-primary" href="/day16">Day 16</a>
					<a class="btn btn-primary" href="/day17">Day 17</a>
					<a class="btn btn-primary" href="/day18">Day 18</a>
					<a class="btn btn-primary" href="/day19">Day 19</a>
					<a class="btn btn-primary" href="/day20">Day 20</a>
